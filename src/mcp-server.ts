...
export class DfirMcpServer extends McpAgent<Env, Record<string, never>, {}> {
  ...
  async init() {
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/briefings/today');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      async ({ limit }) => {
        ...
        const data = await apiFetch<Record<string, unknown>>(`/api/v1/briefings/list${qs}`);
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/live-iocs');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/ransomware-recent');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      async ({ raw_email }) => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/phishing/analyze', {
          method: 'POST',
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/detections');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/threat-pulse');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
    ...
    this.server.tool(
      ...
      {},
      async () => {
        const data = await apiFetch<Record<string, unknown>>('/api/v1/feed-status');
        return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
      }
    );
